-- Security fix: cash-customer creation must be scoped to an authorized business.
...
begin
  ...
  if v_id is null then
    insert into public.customers(
      ...
      p_business_id,'Cash Customer','Cash Customer',null,null,null,'N/A','{}'::jsonb,'{}'::jsonb,0,0,
      'System walk-in customer used by Cash Bill.','{"system":"cash_bill"}'::jsonb,true,false,0,'none',0,'both',0,
...
grant execute on function public.get_or_create_cash_customer(uuid) to authenticated;
